...
; 0000 0032 PORTC=(0<<PORTC7) | (0<<PORTC6) | (0<<PORTC5) | (0<<PORTC4) | (0<<PORTC3) | (0<<PORTC2) | (1<<PORTC1) | (0<<PORTC0);
	LDI  R30,LOW(2)
	OUT  0x15,R30
; 0000 0033 
...
_0x3:
; 0000 0088       {
; 0000 0089         if (PINC.1==1)
	SBIS 0x13,1
	RJMP _0x6
; 0000 008A         {
; 0000 008B             PORTC.0=0xff;
	SBI  0x15,0
; 0000 008C             delay_ms(1000);
	LDI  R26,LOW(1000)
	LDI  R27,HIGH(1000)
	CALL _delay_ms
; 0000 008D             PORTC.0=0x00;
	CBI  0x15,0
