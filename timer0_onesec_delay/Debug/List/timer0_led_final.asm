...
; 0000 0026 if (tot_overflow >= 30)
	...
	BRLO _0x3
; 0000 0027 {
; 0000 0028   TCNT0=0x7A;
	LDI  R30,LOW(122)
	OUT  0x32,R30
; 0000 0029   if (tot_overflow >= 31)
	LDI  R30,LOW(31)
	LDI  R31,HIGH(31)
	CP   R4,R30
	CPC  R5,R31
...
; 0000 003A  TCNT0=0x00;
	LDI  R30,LOW(0)
	OUT  0x32,R30
; 0000 003B  TIMSK |= (1<<TOIE0);
	IN   R30,0x39
	ORI  R30,1
	OUT  0x39,R30
; 0000 003C  // #asm("sei");
; 0000 003D  tot_overflow = 0;
	CLR  R4
	CLR  R5
; 0000 003E }
	RET
...
; 0000 0055 // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=In Bit2=In Bit1=In Bit0=Out
; 0000 0056 DDRC=(0<<DDC7) | (0<<DDC6) | (0<<DDC5) | (0<<DDC4) | (0<<DDC3) | (0<<DDC2) | (0<<DDC1) | (1<<DDC0);
	LDI  R30,LOW(1)
	OUT  0x14,R30
; 0000 0057 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=0
...
; 0000 0062 // Clock value: 7.813 kHz
; 0000 0063 // Mode: Normal top=0xFF
; 0000 0064 // OC0 output: Disconnected
; 0000 0065 // Timer Period: 32 ms
; 0000 0066 TCCR0=(0<<WGM00) | (0<<COM01) | (0<<COM00) | (0<<WGM01) | (1<<CS02) | (0<<CS01) | (1<<CS00);
	LDI  R30,LOW(5)
	OUT  0x33,R30
; 0000 0067 TCNT0=0x06;
	LDI  R30,LOW(6)
	OUT  0x32,R30
; 0000 0068 OCR0=0x00;
	LDI  R30,LOW(0)
