...
_0x0:
	.DB  0xA,0x53,0x6F,0x6D,0x65,0x77,0x68,0x61
	.DB  0x74,0x20,0x45,0x63,0x68,0x6F,0x20,0x54
	.DB  0x65,0x73,0x74,0x3A,0x20,0x0
...
; 0000 005C {
_usart_write_string_modified:
; .FSTART _usart_write_string_modified
...
; 0000 0086       usart_write_string_modified(str);
	LDI  R26,LOW(_str)
	LDI  R27,HIGH(_str)
	RCALL _usart_write_string_modified
