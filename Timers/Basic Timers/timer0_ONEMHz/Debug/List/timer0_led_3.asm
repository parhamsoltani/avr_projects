...
; 0000 0023 TCNT0=0x64;
	LDI  R30,LOW(100)
	OUT  0x32,R30
; 0000 0024 ++tot_overflow;
	MOVW R30,R4
	ADIW R30,1
	MOVW R4,R30
; 0000 0025 // Place your code here
; 0000 0026 if (tot_overflow >= 80)
	LDI  R30,LOW(80)
	LDI  R31,HIGH(80)
	CP   R4,R30
	CPC  R5,R31
...
; 0000 0035  TCNT0=0x64;
	LDI  R30,LOW(100)
	OUT  0x32,R30
; 0000 0036  TIMSK |= (1<<TOIE0);
	IN   R30,0x39
	ORI  R30,1
	OUT  0x39,R30
; 0000 0037  #asm("sei");
	sei
; 0000 0038  tot_overflow = 0;
	CLR  R4
	CLR  R5
; 0000 0039 }
	RET
...
; 0000 0044 DDRA=(0<<DDA7) | (0<<DDA6) | (0<<DDA5) | (0<<DDA4) | (0<<DDA3) | (0<<DDA2) | (0<<DDA1) | (1<<DDA0);
	LDI  R30,LOW(1)
	OUT  0x1A,R30
...
; 0000 0050 DDRC=(0<<DDC7) | (0<<DDC6) | (0<<DDC5) | (0<<DDC4) | (0<<DDC3) | (0<<DDC2) | (0<<DDC1) | (1<<DDC0);
	LDI  R30,LOW(1)
	OUT  0x14,R30
...
; 0000 005C // Clock value: 15.625 kHz
; 0000 005D // Mode: Normal top=0xFF
; 0000 005E // OC0 output: Disconnected
; 0000 005F // Timer Period: 9.984 ms
; 0000 0060 TCCR0=(0<<WGM00) | (0<<COM01) | (0<<COM00) | (0<<WGM01) | (0<<CS02) | (1<<CS01) | (1<<CS00);
	LDI  R30,LOW(3)
	OUT  0x33,R30
; 0000 0061 TCNT0=0x64;
	LDI  R30,LOW(100)
	OUT  0x32,R30
; 0000 0062 OCR0=0x00;
	LDI  R30,LOW(0)
