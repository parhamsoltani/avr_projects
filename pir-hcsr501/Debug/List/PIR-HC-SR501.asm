...
_0x0:
	.DB  0x4D,0x6F,0x74,0x69,0x6F,0x6E,0x20,0x64
	.DB  0x65,0x74,0x65,0x63,0x74,0x65,0x64,0x0
	.DB  0x6D,0x6F,0x74,0x69,0x6F,0x6E,0x6C,0x65
	.DB  0x73,0x73,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 008E // RS - PORTC Bit 0
; 0000 008F // RD - PORTC Bit 1
; 0000 0090 // EN - PORTC Bit 2
; 0000 0091 // D4 - PORTC Bit 4
; 0000 0092 // D5 - PORTC Bit 5
; 0000 0093 // D6 - PORTC Bit 6
; 0000 0094 // D7 - PORTC Bit 7
...
_0x3:
; 0000 0099       {
; 0000 009A         PIR=PINA.0;
	LDI  R30,0
	SBIC 0x19,0
	LDI  R30,1
	MOV  R16,R30
	CLR  R17
; 0000 009B         PORTD.0=PIR;
	CPI  R16,0
	BRNE _0x6
	CBI  0x12,0
	RJMP _0x7
...
; 0000 009E         if(PIR==1)
	...
	BRNE _0x8
; 0000 009F         {
; 0000 00A0             lcd_putsf("Motion detected");
	__POINTW2FN _0x0,0
	RJMP _0xB
; 0000 00A1         }else  { lcd_putsf("motionless"); }
_0x8:
	__POINTW2FN _0x0,16
_0xB:
	RCALL _lcd_putsf
