...
_0x0:
	.DB  0x43,0x0,0x44,0x53,0x31,0x38,0x42,0x32
	.DB  0x30,0x20,0x26,0x20,0x55,0x53,0x41,0x52
	.DB  0x54,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 0047 // USART Receiver: On
; 0000 0048 // USART Transmitter: Off
; 0000 0049 // USART Mode: Asynchronous
; 0000 004A // USART Baud Rate: 9600
...
; 0000 0054 // RS - PORTC Bit 0
; 0000 0055 // RD - PORTC Bit 1
; 0000 0056 // EN - PORTC Bit 2
; 0000 0057 // D4 - PORTC Bit 4
; 0000 0058 // D5 - PORTC Bit 5
; 0000 0059 // D6 - PORTC Bit 6
; 0000 005A // D7 - PORTC Bit 7
; 0000 005B // Characters/line: 8
...
; 0000 0069         lcd_gotoxy(0,1);
	...
	LDI  R26,LOW(1)
	RCALL _lcd_gotoxy
; 0000 006A         lcd_putsf("DS18B20 & USART");
	__POINTW2FN _0x0,2
	RCALL _lcd_putsf
; 0000 006B 
; 0000 006C       }
