...
;unsigned char Array[12] = {'H','E','L','L','O',' ','W','O','R','L','D','!'};
...
; 0000 003F PORTD=(0<<PORTD7) | (0<<PORTD6) | (0<<PORTD5) | (0<<PORTD4) | (0<<PORTD3) | (0<<PORTD2) | (0<<PORTD1) | (0<<PORTD0);
	OUT  0x12,R30
; 0000 0040 
; 0000 0041 // Bit-Banged I2C Bus initialization
; 0000 0042 // I2C Port: PORTC
; 0000 0043 // I2C SDA bit: 1
; 0000 0044 // I2C SCL bit: 0
; 0000 0045 // Bit Rate: 100 kHz
; 0000 0046 // Note: I2C settings are specified in the
; 0000 0047 // Project|Configure|C Compiler|Libraries|I2C menu.
; 0000 0048 TWAR = 0x30 << 1;
	LDI  R30,LOW(96)
	OUT  0x2,R30
; 0000 0049 TWBR = 31;
	LDI  R30,LOW(31)
...
; 0000 0050       delay_ms(1000);
	...
	LDI  R27,HIGH(1000)
	CALL _delay_ms
; 0000 0051       ////////////////////////////////// Start Condition
; 0000 0052       TWCR = 0xA4;
	LDI  R30,LOW(164)
	OUT  0x36,R30
; 0000 0053       while((TWCR&0x80)==0x00);
_0x7:
	IN   R30,0x36
	SBRS R30,7
	RJMP _0x7
; 0000 0054       ////////////////////////////////// Send Slave Address : 0x32
; 0000 0055       ////////////////////////////////// SLA+W => R/W = 0
; 0000 0056       TWDR = (0x32<<1);
	LDI  R30,LOW(100)
	OUT  0x3,R30
; 0000 0057       TWCR = 0x84;
	LDI  R30,LOW(132)
	OUT  0x36,R30
; 0000 0058       while((TWCR&0x80)==0x00);
_0xA:
	IN   R30,0x36
	SBRS R30,7
	RJMP _0xA
; 0000 0059       ////////////////////////////////// Send 5 byte data
; 0000 005A         for(i=0;i<12;i++)
	CLR  R5
_0xE:
	LDI  R30,LOW(12)
	CP   R5,R30
...
; 0000 005D         TWCR = 0x84;
	LDI  R30,LOW(132)
	OUT  0x36,R30
; 0000 005E         while((TWCR&0x80)==0x00);
_0x10:
	IN   R30,0x36
	SBRS R30,7
	RJMP _0x10
