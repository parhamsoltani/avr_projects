...
twi_master_init(100); //I2C clock is set to 100kHz
    ...
    while (1)
    {
        if (dataReady)
        {
            ...
            at24c512_write(0x00, 0x0000, receivedData, 17);
            delay_ms(100);
            at24c512_read(0x00, 0x0000, read_buff, 17);
            // Clear the buffer
            ...
            lcd_gotoxy(0, 1);
            lcd_puts(read_buff); // Display the received data
