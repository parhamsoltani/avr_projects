...
_0x0:
	.DB  0x47,0x61,0x73,0x20,0x61,0x6D,0x6F,0x75
	.DB  0x6E,0x74,0x3A,0x20,0x25,0x64,0x0,0x25
	.DB  0x0
_0x2020003:
	.DB  0x80,0xC0
...
; 0000 0036 float i;
; 0000 0037 int MQ9;
; 0000 0038 unsigned char Buffer_lcd[16];
; 0000 0039 
...
; 0000 006C       MQ9=(i*100)/1023 ;
	...
	CALL __CFD1
	MOVW R16,R30
; 0000 006D       sprintf(Buffer_lcd,"Gas amount: %d",MQ9);
	MOVW R30,R28
	ST   -Y,R31
	ST   -Y,R30
	__POINTW1FN _0x0,0
